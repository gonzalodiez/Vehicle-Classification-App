...
For the initial proof-of-concept, the Data team collected and labelled pictures for 25 different cars. This project will consist on train a model able to classify those vehicles with a high accuracy (over 80% on the testing dataset).
...
You don't have to worry about downloading the data, it will be automatically downloaded from the `VehicleClassificationApp.ipynb` notebook in `Section 1 - Getting the data`.

## Technical aspects

To develop this Machine Learning model the primary interaction will be with the Jupyter notebook provided, called `VehicleClassificationApp.ipynb`. This notebook will guide you through all the steps of the different parts of the project.
...
Note for some of the models in this project, the most efficient way to train them is using GPUs.
...
- Open the folder with you code from Google Drive, right click on the notebook `VehicleClassificationApp.ipynb` and select "Open with:" -> "Google Colaboratory"
